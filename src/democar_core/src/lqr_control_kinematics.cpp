...
{
    //申明参数变量
    this->declare_parameter<std::float_t>("car_length",l_);                         //车长
    ...
    this->declare_parameter<std::float_t>("reference_velocity",vr);                 //参考速度
    
    //从yaml中获取车辆信息
    this->get_parameter("car_length",l_);                         //车长
    ...
    this->get_parameter("reference_velocity",vr);                 //参考速度
